...
class KotaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', 
				...
				'actions'=>array('create','update','daftarKota','propinsi','daftarKota1'),
				'users'=>array('@'),
			),
			array('allow', 
	...
	public function actionPropinsi()
	{
		...
		{
			$model->attributes=$_POST['Kota'];
			$id=$_POST['Kota']['propinsi_id'];
				$this->redirect(array('daftarKota1','id'=>$id));
		}

		$this->render('propinsi',array(
			'model'=>$model,
		));
	}
	...
	public function actionDaftarKota1()
	{
		$this->render('daftarKota1');
	}
	/**
	 * Lists all models.
	 */
