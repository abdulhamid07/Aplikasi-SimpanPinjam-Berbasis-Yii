...
class Anggota extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('pekerjaan_id, penghasilan_perbulan', 'numerical', 'integerOnly'=>true),
			array('nama', 'length', 'max'=>60),
			array('alamat', 'length', 'max'=>75),
			array('jenis_kelamin, agama_id', 'length', 'max'=>1),
	...
	public function search()
	{
		...
		$criteria->compare('agama_id',$this->agama_id,true);
